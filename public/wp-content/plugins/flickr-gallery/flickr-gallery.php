...
if ( defined('CODEMEME_TEST') ) {
	...
	define('CM_FLICKR_GALLERY_VERSION', '1.3.0');
}
		...
		?>
			<div class="wrap">
				...
				<form method="post" action="admin-ajax.php" id="flickr-gallery-settings">
					...
					<input type="hidden" name="page_options" value="fg-tabs,fg-API-key,fg-secret,fg-token,fg-user_id,fg-per_page,fg-db-cache,fg-credit-link,fg-flightbox" />
					<p>
